    ...
    <div className="results-section">
      <div className="info-box">
        <div className="execution-info">
          ...
          <span className="time-value">{executionTime.toFixed(2)} seconds</span>
        </div>
      ...
      <div className="image-container">
        {imageIds.map((id) => (
          <div key={id} className="image-row">
            ...
            <div className="image-wrapper">
              <img
                src={`http://localhost:8000/${imagePath_int}/intersect_result_${id}.png`}
            ...
            <div className="image-wrapper">
              <img
                src={`http://localhost:8000/${imagePath_uni}/union_result_${id}.png`}
                alt={`Union Image ${id}`}
                onClick={() => onSelectImage(id)}
              />
              <p>Union Mask {id}</p>
